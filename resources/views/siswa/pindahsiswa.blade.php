    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="page-title-box">
                <h4 class="page-title">Form Siswa Pindahan</h4>
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="javascript:void(0);">Siswa</a></li>
                    <li class="breadcrumb-item active">Form Siswa Pindahan</li>
                </ol>
            </div>
        </div>
    </div>
                    ...
                    <div class="col-12">
                        ...
                        <div class="form-group row col-6">
                          ...
                          <div class="form-group row col-6">
                            ...
                            <div class="col-9 col-lg-10">
                                <input name="asal_sekolah" type="text" required="" class="form-control" placeholder="Asal Sekolah SD Siswa">
                            </div>  
                        </div>
                        </div>
                    </div>
